...
**잘못 실행한 파일:** `check-and-refresh-views.sql` (에러 발생)

**올바른 파일:** `create-or-refresh-views.sql` (이것 실행!)
...
### 5. 결과 확인
- 여러 개의 Result 탭이 나타남
- "✅ mv_consensus_changes created!" 확인
- "✅ mv_stock_analysis created!" 확인
- 샘플 데이터에서 현실적인 증감률 확인

---

## ✅ 성공 확인

**Result 탭에 다음이 표시되어야 함:**
1. Step 1: 기존 View 확인
2. Step 2: mv_consensus_changes 생성 완료
3. Step 3: mv_stock_analysis 생성 완료
4. Step 4: 샘플 데이터 (상위 10개 기업)
5. Step 5: 점수 분포
...
**샘플 데이터에서:**
- ✅ revenue_growth_1month가 -100 또는 100이 아님
- ✅ 현실적인 값 (예: 2.5, -1.8, 5.3 등)
- ✅ consensus_score가 0, 20, 40, 60, 80, 100 다양

---

**이 스크립트를 복사해서 실행하면 됩니다!** 🚀
