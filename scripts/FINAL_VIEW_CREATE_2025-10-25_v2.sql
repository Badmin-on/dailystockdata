-- ================================================================
-- FINAL VIEW CREATE SCRIPT - 2025-10-25 v2 (FIXED)
-- ================================================================
-- 데이터 정규화 후 View 생성
-- ORDER BY 에러 수정
-- ================================================================
...
-- Step 5: Score distribution (FIXED ORDER BY)
SELECT 
...
ORDER BY 
  CASE 
    WHEN consensus_score IS NULL THEN 0
    WHEN consensus_score = 0 THEN 1
    WHEN consensus_score < 30 THEN 2
    WHEN consensus_score < 60 THEN 3
    WHEN consensus_score < 80 THEN 4
    WHEN consensus_score = 100 THEN 5
    ELSE 6
  END;
